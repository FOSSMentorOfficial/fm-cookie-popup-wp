...
class CI_Iframe {
	...
	public function replace_with_alternate_text( $tags ) {
		...
		if ( ! empty( $src[2] ) || $src[2] !== 'about:blank' ) {
			...
			return '<div class="gdprcookiemaker-alternate-text" data-type="' . $iframe_type . '"><h5>' . __( 'Please accept our cookies', 'b2b-market' ) . '</h5><p>' . get_option( 'bm_cc_iframe_alternative_text' ) . '</p></div>';
